  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('حول البرنامج',style: TextStyle(color: Colors.black),),
        centerTitle: true,
      ),
        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: Text('''بسم الله ، والحمد لله ، ونصلي على رسول الله
                  ...
                  Column(
                    children: [
                      IconButton(onPressed: () {
                        whatsapp("https://l.facebook.com/l.php?u=https%3A%2F%2Fapi.whatsapp.com%2Fsend%2F%3Fphone%3D201027790713%26text%26app_absent%3D0%26fbclid%3DIwAR0B66FNvgVt3Y9kNDUkbVWLhy50BUo3rWQetC86WmH-HuS6YgTMofzJOaA&h=AT24d8sM0oSOxShMV9xha4CJ74JGOnpuNeGhG5wU-P6JTP_0u3FkKMa2fA1-I1inJUaVau90EAm2d11Sunvh-_wZjfgVHEjHFNuFtKUWdXV21aIHdEEMNFC_Ju_N2jDdfIR68A");
